...
const TinaPlacePicker = wrapFieldsWithMeta((props: CustomTinaFieldProps) => {
    ...
    return (
        ...
        //     <Listbox.Button>
        //         {places && places.features.find((place) => place.properties.uuid == props.input.value.uuid)?.properties.title || 'Select a place'}
        //     </Listbox.Button>
        //     <Listbox.Options>
        //         {
        //             places && places.features.map((place) => (
        //                 <Listbox.Option key={place.properties.uuid} value={{ uuid: place.properties.uuid, title: place.properties.title}}>{place.properties.title}</Listbox.Option>
        //             ))
        //         }
        //     </Listbox.Options>
        // </Listbox>
